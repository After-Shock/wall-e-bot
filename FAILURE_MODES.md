...
| Migration failure | The failing step rolls back; later steps do not run. A checksum mismatch stops startup rather than accepting edited history. | Fix forward with a new migration or correct the unapplied step, then rerun before replacing services. Never edit an applied migration. |
